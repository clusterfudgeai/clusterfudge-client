...
class Command(_message.Message):
    __slots__ = ("tenant_id", "hostname", "id", "requested_by", "requested_at", "acknowledged_at", "command", "env", "reference_id", "execution_started_at", "execution_completed_at", "exec_err", "exit_code", "state", "pid", "cmd_line", "resource_request")
