...
class Command(_message.Message):
    __slots__ = ["acknowledged_at", "cmd_line", "command", "env", "exec_err", "execution_completed_at", "execution_started_at", "exit_code", "git_branch", "git_commit", "git_repo", "hostname", "id", "job_name", "pid", "reference_id", "requested_at", "requested_by", "resource_request", "server_state", "state", "tenant_id", "zip_id"]
