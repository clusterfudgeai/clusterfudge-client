...
class CreateLaunchRequest(_message.Message):
    __slots__ = ["command", "command_to_run", "description", "hostnames", "launched_by", "replica_resources", "replicas", "title"]
...
class Launch(_message.Message):
    __slots__ = ["command", "command_to_run", "description", "hostnames", "id", "launch_id", "launched_by", "replica_resources", "replicas", "status", "submitted_at", "title"]
