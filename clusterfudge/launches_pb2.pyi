...
class ListLaunchesResponse(_message.Message):
    ...
    def __init__(
        self, launches: _Optional[_Iterable[_Union[Launch, _Mapping]]] = ...
    ) -> None: ...
...
class Launch(_message.Message):
    ...
    def __init__(
        self,
        launch_id: _Optional[int] = ...,
        launched_by: _Optional[str] = ...,
        submitted_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...,
        command_to_run: _Optional[str] = ...,
        command: _Optional[_Iterable[str]] = ...,
        hostnames: _Optional[_Iterable[str]] = ...,
        status: _Optional[_Union[Launch.Status, str]] = ...,
        id: _Optional[str] = ...,
        title: _Optional[str] = ...,
        description: _Optional[str] = ...,
        replicas: _Optional[int] = ...,
        replica_resources: _Optional[_Union[_resources_pb2.Resources, _Mapping]] = ...,
    ) -> None: ...
...
class ListLaunchesWithCommandStatusesResponse(_message.Message):
    ...
    def __init__(
        self,
        launches: _Optional[
            _Iterable[_Union[LaunchWithCommandStatuses, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class LaunchWithCommandStatuses(_message.Message):
    __slots__ = (
        "launch",
        "commands_unknown_count",
        "commands_unacknowledged_count",
        "commands_acknowledged_count",
        "commands_running_count",
        "commands_succeeded_count",
        "commands_failed_count",
        "commands_killed_count",
        "commands_cancelled_count",
    ...
    def __init__(
        self,
        launch: _Optional[_Union[Launch, _Mapping]] = ...,
        commands_unknown_count: _Optional[int] = ...,
        commands_unacknowledged_count: _Optional[int] = ...,
        commands_acknowledged_count: _Optional[int] = ...,
        commands_running_count: _Optional[int] = ...,
        commands_succeeded_count: _Optional[int] = ...,
        commands_failed_count: _Optional[int] = ...,
        commands_killed_count: _Optional[int] = ...,
        commands_cancelled_count: _Optional[int] = ...,
        commands_total_count: _Optional[int] = ...,
    ) -> None: ...
